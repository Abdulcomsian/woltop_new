...
const cartSlice = createSlice({
  ...
  reducers: {
    ...
    updateItemQuantity(state, action: PayloadAction<{ id: number; variableId: number; quantity: number }>) {
    ...
    removeItemFromCart(state, action: PayloadAction<{ id: number; variableId: number }>) {
