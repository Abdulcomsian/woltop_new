    ...
    <main className="">
      ...
      <section>
        <div className="m-auto w-2/3 bg-white p-3 max-[568px]:w-full md:p-4">
          ...
          <button className="hover:bg-accent-hover focus:ring-accent-700 inline-flex w-full items-center justify-center rounded-lg border border-transparent bg-[#49AD91] px-5 py-2 font-semibold text-white focus:ring-2">
            ADD ADDRESS
          </button>
