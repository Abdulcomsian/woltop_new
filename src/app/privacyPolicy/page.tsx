  ...
  return (
    ...
    >
      <section className="bg-light mx-auto w-full px-3 pb-8 lg:pb-10 xl:pb-14">
        <h1 className="text-brand-dark py-[64px] text-center text-xl font-bold md:text-2xl lg:text-3xl 2xl:text-[40px]">
          <span className="text-3xl font-semibold text-black md:text-[48px]">
            Privacy Policy
          </span>
        </h1>
        ...
        <div className="w-fullpy-10 mx-auto">
          <div>
            <h2 className="mb-3 text-2xl font-medium text-black md:text-[30px]">
              Overview
            </h2>
            <p className="text-sm text-[#00000080] md:text-lg">
              ...
              pellentesque. Dolor vitae, amet, ornare suspendisse.
            </p>
            <p className="text-sm text-[#00000080] md:text-lg">
              ...
              tellus velit sociis. Ut augue tellus sed at. Duis morbi lorem nibh
              amet, mus urna, purus velit. Mi condimentum laoreet sed iaculis
              nunc vestibulum nunc diam tortor. Pulvinar orci, non lectus nec
              duis. Adipiscing vitae augue sed sapien purus.
            </p>
            <p className="text-sm text-[#00000080] md:text-lg">
              Porttitor at eu mi, non enim nunc diam. Vel nisl cursus nam risus
              morbi ac venenatis faucibus ac. Enim ullamcorper nullam in
              aliquam, curabitur dapibus risus interdum cursus. Arcu et quis
              egestas scelerisque tempor, mauris. Dictum amet odio pellentesque
              ...
              Vitae eu ultrices adipiscing commodo. Interdum vivamus enim ut
              diam nisl.
            </p>
            <p className="text-sm text-[#00000080] md:text-lg">
          ...
          <div>
            <h2 className="mb-3 mt-4 text-2xl font-medium text-black md:text-[30px]">
              Terms of Services
            </h2>
            <p className="text-sm text-[#00000080] md:text-lg">
          ...
          <div>
            <h2 className="mb-3 mt-4 text-2xl text-[30px] font-medium text-black md:text-[30px]">
              Online Store Terms
            </h2>
            <p className="text-sm text-[#00000080] md:text-lg">
