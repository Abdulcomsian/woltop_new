      ...
      <div className="flex space-x-4">
        ...
        <div>
          <a href="#" className="flex items-center py-5 px-2 text-gray-700 hover:text-gray-900">
            ...
            <span className="h-[2.125rem] md:w-[8.625rem] overflow-hidden relative w-32">
               <img src={footerLogo.src} className='object-contain' style={{
      ...
      <div className="hidden md:flex items-center space-x-1">
       ...
       <div className="hidden lg:inline-flex">
        ...
        <svg viewBox="0 0 17.048 18"  className="h-5 w-5">
            ...
            rounded-full  text-white text-[10px] absolute ltr:-right-1/2 rtl:-left-1/2 
            -top-1/2  bg-[#49AD91]" >1</span></button>
