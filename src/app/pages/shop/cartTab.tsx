...
const CartTab: React.FC<CartTabProps> = ({ setActiveTab }) => {
  ...
  const cartData = useSelector((state: any) => state.cart); // Access cart items from Redux
                ...
                >
                  <div className="relative flex h-[173px] w-2/5 shrink-0 items-center justify-center overflow-hidden bg-gray-100">
                    <img
                      ...
                      src={item?.featured_image || "https://placehold.co/600x400.png"}
                    />
                  </div>
                  <div className="relative w-full px-2">
                    ...
                    {/* Replace with the actual size if available */}
                    <div className="flex">
                      ...
                      <div className="text-body my-2.5 ml-2 w-20 pt-2 text-xs text-[#9e9e9e] line-through">
                        ₹{item.originalPrice}{" "}
                        {/* Replace with the actual original price if available */}
                      </div>
                    </div>
                    <div className="badge">
