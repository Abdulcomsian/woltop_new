         ...
         <div className=" container px-5 m-auto  ">
            ...
            <div
               ...
               <a className="inline-flex" href="/">
                  ...
                  <a className="text-accent hover:text-accent-hover" target="_blank"
            ...
            <div className="devider  mt-12 mb-12 
            ...
            <div className="flex flex-col gap-1 lg:container lg:m-auto mt-4 pt-4">
