    ...
    <section className="m-auto w-full md:w-3/6">
      <div className="md:p-4d m-auto w-full bg-white">
        <div className="rounded">
          ...
          <div
            className={`installation relative flex w-full items-center rounded-lg border-0 bg-[#2ECDA01A] p-[10px] md:p-0`}
          >
            {/* Checkbox */}
            <div
              className=""
            ...
            >
              <input
                ...
                className="h-[15px] w-[15px] cursor-pointer appearance-none rounded-full border-2 border-gray-400 bg-red-500 checked:border-[#49AD91] checked:bg-[#49AD91] focus:outline-none focus:ring-2 focus:ring-[#49AD91]"
              />
                ...
                <div className="checkout-cart grid grid-cols-1">
                  {cartData?.items?.map((item: any, index: number) => (
                    <div
                      ...
                      className={`border-border-200 flex w-full gap-2 ${cartData?.items?.length > 1 && "border-b-2 pb-4"} border-opacity-75 text-sm`}
                      style={{ opacity: "1" }}
                    >
        ...
        <div>
          ...
          <div className="flex justify-end gap-1 bg-white py-3">
