...
export default function Calculator({
  ...
  return (
    <div>
      ...
      {isCalculatorVisible && (
        <div className="mt-4 flex flex-col gap-4 rounded-md border bg-[#FFF3F6] p-4">
          <h2 className="text-center font-poppins text-base font-medium">
          ...
          <div className="mx-auto my-2 flex flex-col justify-center gap-4 xl:flex-row">
            <div className="flex flex-col gap-1">
              <label className="font-poppins text-xs font-normal uppercase">
                Width
              </label>
              <div className="relative">
                <input
                  ...
                  placeholder="0"
                />
                <span className="absolute right-2 top-0 flex h-full items-center text-gray-500">
                  {isMeter ? "Ft" : "M"}
                </span>
              </div>
            </div>
          ...
          <div className="flex justify-center">
            <div className="mt-4 w-1/2 rounded-full border-2 border-dashed border-pink-300 bg-white p-2 text-center">
